...
const OperatorDashboard1 = () => {
    ...
    useEffect(() => {
        const loadCellRef = ref(db, "Sigalagala/berat");
    ...
    useEffect(() => {
        const operator = "Sigalagala"; // Adjust dynamically if needed
  ...
  .filter(v => v.operator === "Sigalagala" && v.nettobersih && v.pricePerKg)
  .reduce((sum, v) => sum + v.nettobersih * v.pricePerKg, 0);

  const totalNettoBersih = vehicles
  .filter(v => v.operator === "Sigalagala" && v.nettobersih)
        ...
        <div className="container mt-4">
            ...
            <div className="table-responsive">
                <table className="table custom-table">
                    ...
                    <tbody>
                        {vehicles
                            .filter(vehicle => vehicle.operator === "Sigalagala")
                            .filter(vehicle => {
