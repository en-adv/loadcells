...
const OperatorDashboard1 = () => {
    ...
    useEffect(() => {
        const loadCellRef = ref(db, "timbangan/Sigalagala/berat");
    ...
    useEffect(() => {
        const operator = "Sigalagala"; // Ensure this is dynamically set later
        ...
        <div className="container mt-4">
            ...
            <div className="table-responsive">
               ...
               <thead className="custom-thead">    
                    ...
                    <tbody>
    {vehicles
        .filter(vehicle => vehicle.operator === "Sigalagala") // Adjust for dynamic operator filtering
