...
const OperatorDashboard5 = () => {
    ...
    useEffect(() => {
        const loadCellRef = ref(db, "timbangan/lokasi5/berat");
    ...
    useEffect(() => {
        const operator = "operator5";  // Make sure it's dynamically assigned
    ...
    useEffect(() => {
        const operator = "operator5"; // Ensure this is dynamically set later
    ...
    const handleSubmit = () => {
        ...
        const operator = "operator5";  // ✅ Replace this with actual logged-in operator
                ...
                <div className="col-md-4 mb-3">
                    <div className="card text-center">
                        <div className="card-body">
                            <h5 className="card-title">Timbangan Portibi</h5>
...
export default OperatorDashboard5;
