...
const OperatorDashboard3 = () => {
    ...
    useEffect(() => {
        const loadCellRef = ref(db, "Paranjulu/berat");
    ...
    useEffect(() => {
        const operator = "Paranjulu"; // Sesuaikan atau ambil dari JWT
    ...
    useEffect(() => {
        const operator = "Paranjulu";  // Make sure it's dynamically assigned
    ...
    useEffect(() => {
        const operator = "Paranjulu"; // Adjust dynamically if needed
    ...
    const handlePrint = async (vehicle) => {
        try {
            ...
            const characteristic = await service.getCharacteristic("00002af1-0000-1000-8000-00805f9b34fb");// 3. Generate Invoice Text with Proper ESC/POS Formatting
            ...
            const invoiceText =
                ...
                SEPARATOR +
                CENTER + BOLD_ON + "Paranjulu HP. (0823 6864 6268) \n" + BOLD_OFF +
                LINE_FEED +
    ...
    const handleSubmit = () => {
        ...
        const operator = "Paranjulu";  // ✅ Replace this with actual logged-in operator
        ...
        <div className="container mt-4">
                ...
                <div className="col-md-4 mb-3">
                    <div className="card text-center">
                        <div className="card-body">
                            <h5 className="card-title">Timbangan Paranjulu</h5>
            ...
            <div className="table-responsive">
               ...
               <thead className="custom-thead">    
                    ...
                    <tbody>
    {vehicles
        .filter(vehicle => vehicle.operator === "Paranjulu") // Adjust for dynamic operator filtering
...
export default OperatorDashboard3;
