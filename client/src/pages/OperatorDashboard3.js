...
const OperatorDashboard3 = () => {
    ...
    useEffect(() => {
        const loadCellRef = ref(db, "timbangan/lokasi3/berat");
    ...
    useEffect(() => {
        const operator = "operator3";  // Make sure it's dynamically assigned
    ...
    useEffect(() => {
        const operator = "operator3"; // Ensure this is dynamically set later
    ...
    const handleSubmit = () => {
        ...
        const operator = "operator3";  // ✅ Replace this with actual logged-in operator
