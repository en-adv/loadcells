...
const OperatorDashboard3 = () => {
    ...
    const handlePrint = async (vehicle) => {
        try {
            ...
            SEPARATOR +
            CENTER + "Paranjulu HP. (0813 9777 7354)\n" +
            LINE_FEED +
            LEFT +
            ...
            alert("Gagal Mencetak No ❌");
        }
    };
    
    const totalPembayaran = vehicles
  .filter(v => v.operator === "Paranjulu" && v.nettobersih && v.pricePerKg)
  .reduce((sum, v) => sum + v.nettobersih * v.pricePerKg, 0);

  const totalNettoBersih = vehicles
  .filter(v => v.operator === "Paranjulu" && v.nettobersih)
        ...
        <div className="container mt-4">
            ...
            <div className="row">
                <div className="col-md-6">
                    ...
                    />
                    {inputStatus && (
                        <div className={`mt-2 p-2 rounded ${inputStatus === "Complete" ? "bg-success" : "bg-info"} text-white`}>
                            Status: {inputStatus}
                        </div>
                    )}
                </div>
            ...
            <div className="table-responsive">
               ...
               <thead className="custom-thead">    
                    ...
                    <tbody>
    {vehicles
        .filter(vehicle => vehicle.operator === "Paranjulu") 
        .filter(vehicle => {
